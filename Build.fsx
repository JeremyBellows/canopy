...
let summary = "f# web automation and testing library, built on top of Selenium (friendly to c# also)"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "F# web automation and testing library, built on top of Selenium. Compatible with c#"

// List of author names (for NuGet package)
let author = "Chris Holt"

// Tags for your project (for NuGet package)
let tags = "automation testing selenium web"

// File system information
let solutionFile  = "canopy.sln"
...
let gitHome = sprintf "%s/%s" "https://github.com/lefthandedgoat/canopy" gitOwner

// The name of the project on GitHub
let gitName = "canopy"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/lefthandedgoat"
...
Target.create "RunTests" (fun _ ->
    //RunTests does nothing atm. we need to run the dotnet dlls using DotNet.exec
...
let info =
  [ "project-name", "canopy"
    ...
    "project-summary", "f# web automation and testing library, built on top of Selenium (friendly to c# also)"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/canopy" ]
